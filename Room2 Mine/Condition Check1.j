function Trig_Condition_Check1_Conditions takes nothing returns boolean
...
function Trig_Condition_Check1_Func001C takes nothing returns boolean
...
function Trig_Condition_Check1_Actions takes nothing returns nothing
    if ( Trig_Condition_Check1_Func001C() ) then
        call DisableTrigger( GetTriggeringTrigger() )
        call DisplayTimedTextToForce( GetPlayersAll(), 10.00, "TRIGSTR_090" )
...
//===========================================================================
function InitTrig_Condition_Check1 takes nothing returns nothing
    set gg_trg_Condition_Check1 = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ( gg_trg_Condition_Check1, EVENT_PLAYER_UNIT_SPELL_EFFECT )
    call TriggerAddCondition( gg_trg_Condition_Check1, Condition( function Trig_Condition_Check1_Conditions ) )
    call TriggerAddAction( gg_trg_Condition_Check1, function Trig_Condition_Check1_Actions )
endfunction